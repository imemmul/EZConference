...
class Audio:
    def __init__(self):
        self.audio_stream = pa.open(rate=44100, channels=1, format=pyaudio.paInt16, input=True, frames_per_buffer=4096)
    ...
    def get_stream(self):
        try:
            ...
            if e.errno == pyaudio.paInputOverflowed:
                print("Input overflowed, dropping frame")
            else:
                raise e
        return self.audio
...
class PlayAudio(QThread):
    def __init__(self, client):
        ...
        self.connected = True
        self.client = client
        self.audio_stream = pa.open(rate=44100, channels=1, format=pyaudio.paInt16, output=True, frames_per_buffer=4096)
